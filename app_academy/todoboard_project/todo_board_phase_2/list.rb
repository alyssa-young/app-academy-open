...
class List
    ...
    def print
        ...
        puts "                    #{@label}                                                      "
        puts "-----------------------------------------------------------------------------------"
        puts "Index".ljust(20) + "|Item ".ljust(20) + "|Deadline".ljust(20) + "|Done".ljust(20)
        puts "-----------------------------------------------------------------------------------"
        @items.each_with_index do |item, i|
            ...
            puts "#{i}".ljust(20) + "|#{item.title}".ljust(20) + "|#{item.deadline}".ljust(20) + "|[ #{status} ]".ljust(20)
        end
        puts "----------------------------------------------------------------------------------"
    end
    def print_full_item(index)
        ...
        puts "#{item.title}".ljust(38) + "#{item.deadline}".rjust(20) + "[ #{status} ]".rjust(20)
